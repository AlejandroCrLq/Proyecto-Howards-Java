...
public class LoginController implements ActionListener {
	...
	/**
	 * M�todo que a�ade los listeners al bot�n del login.
	 */
	...
	/**
	 * M�todo que controla el acceso a la aplicaci�n. En caso de error muestra un mensaje y en caso contrario
	 * permite el acceso a la aplicaci�n.
	 */
	@Override
	...
	/**
	 * M�todo que permite comprobar la contrase�a en la base de datos y compararla con la escrita por el usuario.
	 * @param password Contrase�a escrita por el usuario en la ventana login.
	 * @return Devuelve true si la contrase�a es correcta y false si es erronea.
	 */
